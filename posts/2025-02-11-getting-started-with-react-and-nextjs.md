...
```jsx
import Link from "next/link"; // NEXT의 link import
...
<aside>
<img src="https://www.notion.so/icons/asterisk_red.svg" alt="https://www.notion.so/icons/asterisk_red.svg" width="40px" />
...
const GsapAnimation = dynamic(() => import("@/components/GsapComponent"), {
  ssr: false,
});
